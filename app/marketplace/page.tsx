  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-muted/10">
        {/* Marketplace Header */}
        <section className="bg-background border-b border-border/40 py-16">
          <div className="container max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="space-y-4 max-w-2xl text-center md:text-left">
                ...
                <h1 className="text-5xl font-black tracking-tight">The Marketplace</h1>
              ...
              <div className="w-full max-w-md relative group">
                ...
                <input 
                  ...
                  className="w-full h-14 pl-12 pr-4 rounded-2xl border border-border bg-background shadow-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all text-sm font-medium"
                />
              </div>
            </div>
          </div>
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-xl font-bold">
                  ...
                  <span className="ml-2 text-sm font-medium text-muted-foreground">({filteredKits.length})</span>
                </h2>
                <select className="bg-transparent border-none text-sm font-bold text-muted-foreground outline-none cursor-pointer hover:text-foreground">
              ...
              {loading ? (
                ...
                <div className="py-32 text-center rounded-3xl border-2 border-dashed border-border bg-background/50">
